        ...
        <div className="d-flex justify-content-between">
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.temperature}<span>&#8451;</span></p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Wind Speed</h3>
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.windspeed}</p>
                </div>
            </div>
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.winddirection}</p>
                </div>
            </div>
        </div>
        <div className="d-flex justify-content-between my-5 ">
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.humidity}<span>&#8451;</span></p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Pressure</h3>
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.pressure}</p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Feels Like</h3>
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{props.feellike}</p>
                </div>
            </div>
        </div>    
    </div>
