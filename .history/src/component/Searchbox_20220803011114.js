...
export default function Searchbox() {
    ...
    const weatherdeatail=async(city)=>{
        ...
        setState({
            ...
            feellike:Prasedata.current.feelsli_c
        });
        console.log(state);
        console.log(city);
        console.log(url)
  ...
  return (
    <div> 
        ...
        <div className="row d-flex justify-betwee">  
        <div className="col-md-3">
                <h1>Weather</h1>
                    ...
                    <form className="form-inline d-flex col-md-3" onSubmit={formSubmit} >
                        ...
                        <input className="form-control mr-sm-2" value={city} onChange={handleChange}  type="text" placeholder="Enter city name"/>
                    </form>
        ...
        <div className="d-flex justify-content-between my-5 ">
            ...
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{state?.feellike}</p>
                </div>
            </div>
        </div>    
    </div>
