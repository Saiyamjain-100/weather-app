        ...
        <div className="d-flex justify-content-between">
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{temperature}<span>&#8451;</span></p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Wind Speed</h3>
            ...
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{winddirection}</p>
                </div>
            </div>
        </div>
        <div className="d-flex justify-content-between my-5 ">
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{humidity}<span>&#8451;</span></p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Pressure</h3>
            ...
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4">{feellike;s}</p>
                </div>
            </div>
        </div>    
    </div>
    <div className='footer text-center'>
    <p class="footer-dark">Made with <span>&#10084;</span>  by <cite title="Source Title">Saiyam jain</cite></p>
    </div>
      </div>
    )
  }
