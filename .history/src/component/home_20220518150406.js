...
export default class home extends Component {
  render() {
    return (
      <div style={background-image: 'url('./background1.jpg')' background-repeat: no-repeat;
        ...
        <div className="d-flex justify-content-between">
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4"style="text-size-adjust: 20px;">32<span>&#8451;</span></p>
                </div>
            </div>
            <div className="col-md-3">
                <h3>Wind Speed</h3>
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4"style="text-size-adjust: 20px;">20</p>
                </div>
            </div>
            <div className="col-md-3">
                ...
                <div className="d-flex justify-content-start">
                    ...
                    <p className="mx-4"style="text-size-adjust: 20px;">NW</p>
                </div>
            </div>
        </div>
